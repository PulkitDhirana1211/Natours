...
exports.updateMe = catchAsync(async (req, res, next) => {
    ...
    if (req.body.password || req.body.passwordConfirm) {
        return next(new AppError('This route is not for password updates. Please use /updateMyPassword for that', 400));
    }
    // Filter out unwanted fields which can't be updated
...
// Updating for info other than passwords
